...
namespace PalindromeFiles
{
    class Program
    {
        ...
        {
            DirectoryInfo dInfo = new DirectoryInfo(@"C:\Users\acer\Desktop\PP2\week2\NameofTXT\NameofTXT\bin\Debug");
            ...
            foreach (var txtFile in txtFiles)
            {
                ...
                bool isPalindrome = IsPalindrome(txtFile.Name.ToLower().Split('.')[0]); // first par of string by index
